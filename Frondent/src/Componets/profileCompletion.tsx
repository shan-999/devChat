        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-lg p-6">
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              {formData.languages.length === 0 && <span className="ml-auto text-xs text-red-400">* Required</span>}
            </div>
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              {formData.experience === "" && <span className="ml-auto text-xs text-red-400">* Required</span>}
            </div>
            ...
            <select
              ...
              className={`w-full bg-gray-700 border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-violet-500 ${
                formData.experience === "" ? "border-red-400" : "border-gray-600"
              }`}
            >
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              {formData.profession === "" && <span className="ml-auto text-xs text-red-400">* Required</span>}
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {connectionOptions.map((connection) => (
                <label
                  key={connection.id}
                  className={`flex items-center p-3 rounded-lg border cursor-pointer transition-colors ${
                    formData.connectionPreferences.includes(connection.id)
                      ? "bg-violet-900 border-violet-600"
                      : "bg-gray-700 border-gray-600 hover:border-gray-500"
                  }`}
                >
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              {formData.bio.trim() === "" && <span className="ml-auto text-xs text-red-400">* Required</span>}
            </div>
            ...
            <textarea
              ...
              rows={4}
              className={`w-full bg-gray-700 border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-violet-500 ${
                formData.bio.trim() === "" ? "border-red-400" : "border-gray-600"
              }`}
